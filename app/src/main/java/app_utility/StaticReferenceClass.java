...
public class StaticReferenceClass {
    ...
    public static final int PORT_NO = 9060;//8069;//9040


    public static final String DB_NAME = "Shridhar-Live-1003";//"ARS";//"chellaminfotech-ars-master-73173";//"ARS_9040";//"test_db";//"auto";//
